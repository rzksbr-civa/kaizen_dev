...
<div class="panel panel-default">
	<div class="panel-body">
		<form id="form-idle-picking-batch-board-filter">
...
<div id="idle-picking-batch-board-visualization-area">
	<?php echo $idle_picking_batch_board_visualization_html; ?>
</div>
