...
<div class="panel panel-default">
	<div class="panel-body">
		<form id="form-idle-break-board-filter">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<div class="form-group">
						...
						<select class="form-control multiple-selectized" id="input-department" name="department[]">
							<option value="">All Departments</option>
							<?php
								foreach($department_list as $item) {
									$selected = (in_array($item['id'], $department)) ? ' selected' : '';
				...
				<div class="col-md-2">
					<div class="form-group">
						...
						<select class="form-control multiple-selectized" id="input-status" name="status[]">
							...
							<?php
								foreach($status_list as $status_code => $status_label) {
									$selected = (in_array($status_code, $status)) ? ' selected' : '';
									echo '<option value="'.$status_code.'"'.$selected.'>'.$status_label.'</option>';
								}
							?>
						</select>
					</div>
...
<div id="idle-break-board-visualization-area">
	<?php echo $idle_break_board_visualization_html; ?>
</div>
