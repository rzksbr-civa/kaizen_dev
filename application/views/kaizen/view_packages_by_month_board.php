...
<div class="page-header">
	<h3 style="text-align:center; color: #C52428;">
		...
		PACKAGES BY MONTH BOARD
	</h3>	
</div>

<div class="panel panel-default">
	<div class="panel-body">
		<form id="form-packages-by-month-board-filter">
...
<div id="packages-by-month-board-visualization">
	<?php echo $packages_by_month_board_visualization_html; ?>
</div>
