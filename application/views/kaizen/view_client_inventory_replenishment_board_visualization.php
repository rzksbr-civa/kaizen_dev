		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="table-area">
					<table class="table datatabled-entity table-bordered client-inventory-replenishment-board-table" id="client-inventory-replenishment-board-table" style="width:1530px;">
						<thead>
