...
<div class="page-header">
	<h3 style="text-align:center; color: #C52428;">
		...
		INVENTORY COUNTS BOARD
	</h3>
</div>

<div class="panel panel-default">
	<div class="panel-body">
		<form id="form-inventory-counts-board-board-filter">
...
<div id="inventory-counts-board-visualization-area">
	<?php echo $inventory_counts_board_visualization_html; ?>
</div>
